...
type NodeBaseURLProbeState struct {
	...
	LastSuccessBaseURL   string               `json:"last_success_base_url,omitempty"`
...
type ChannelOtherSettings struct {
	...
	BaseURLProbeLastTime                  int64                            `json:"base_url_probe_last_time,omitempty"`
	BaseURLProbeResults                   []BaseURLProbeResult             `json:"base_url_probe_results,omitempty"`
	BaseURLProbeByNode                    map[string]NodeBaseURLProbeState `json:"base_url_probe_by_node,omitempty"`
}
